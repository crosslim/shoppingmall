const shopInfo = {
  customerCenter : '070-000-0000',
  bank : [
    {
      bankName : '국민은행',
      bankNum : '102-06543-123455',
      name : '예금주:테스트',
    },
    {
      bankName : '부산은행',
  ...
  location : '부산시 금정구 장전2동',
  shopName : '이엔',
  ceoName : 'endesign',
  businessNumber : '555-55-5555',
  telemarketingBusiness : '신고준비중',
  infoProtectionManager : 'en(admin@gmail.com)',
  tel:'02-000-0000',
  address : '부산광역시 금정구 장전2동',
  copyLightName : 'EN',
  businessHours : {
    Weekday : '10:00 ~ 18:00',
    lucnh: '12:00 ~ 13:00',
    holiday : '토요일, 일요일, 공휴일 휴무',
    holiday2 : '토/일요일, 공휴일 휴무'
  }
